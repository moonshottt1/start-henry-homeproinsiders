/* Social Proof Toasts — Roof Replacement */
(function() {
  // Inject styles
  ...
  var templates = [
    ...
    '{name} in {city} just got matched with top roofers',
    'A homeowner in {city} just secured roofer pricing',
    '{name} from {city} just claimed their spot',
    '{name} in {city} just got their roof estimate back',
    'A {city} homeowner just got connected — roofers are booking fast',
    '{name} from {city} just grabbed a quote before prices change',
    '{name} in {city} just got matched — roofers are responding fast',
    '{name} from {city} just saw the latest roof pricing',
    'A homeowner near {city} just jumped on new rates',
    '{name} in {city} just submitted — roofers are responding now',
    '{name} from {city} just compared prices and picked a roofer',
    'A {city} resident just got 3 roofer quotes back',
    '{name} in {city} just took advantage of current pricing',
    '{name} from {city} just started — spots are filling up',
    '{name} in {city} just got matched with a trusted roofer',
    'A {city} homeowner just connected with a 5-star workmanship roofer',
    '{name} from {city} just got paired with a trusted, top-rated roofer'
  ];
